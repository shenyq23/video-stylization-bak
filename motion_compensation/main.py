...
def main(args):
    ...
    # pixel video
    final_output_frames = []
    output_path = os.path.join("./output", args.video_name, config, "pixel.mp4")
    ...
    if args.write_diff:
        diff_output_path = os.path.join("./output", args.video_name, config, f"diff_{args.diff_mode}_amp_{args.diff_amplify}.mp4")
        diff_frames = []
        diff_mae = []
        for i in range(len(frames)):
        ...
        diff_plot_path = os.path.join("./output", args.video_name, config, f"diff_{args.diff_mode}_amp_{args.diff_amplify}.png")
        plt.savefig(diff_plot_path)

    # flow & occlusion video
    final_output_frames = []
    flow_output_path = os.path.join("./output", args.video_name, config, "flows.mp4")
    ...
    plot_output_path = os.path.join("./output", args.video_name, config, "occlusion_ratio.png")
